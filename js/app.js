...
async function fetchData(){
  try{
    ...
    updateFreezeBar();
    if(!frozen){ setStatus("LIVE • "+new Date().toLocaleTimeString(),true); setTimeout(()=>setStatus("",false),1800); }
  }catch(err){ console.error(err); setStatus("Sheet error: "+err.message,true); }
}
